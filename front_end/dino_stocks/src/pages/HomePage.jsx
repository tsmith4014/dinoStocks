      ...
      <Container fluid id="features">
        ...
        <Card className="mb-3">
          <Row className="g-0">
            ...
            <Col md={6}>
              <Card.Body>
                <Card.Title className="cardtitle">Buy and Sell Shares of Dinosaurs</Card.Title>
        ...
        <Card className="mb-3">
          <Row className="g-0">
            <Col md={6} >
              <Card.Body>
                <Card.Title className="cardtitle">Watch Your Portfolio</Card.Title>
                <Card.Text className="cardtext">
        ...
        <Card className="mb-3">
          <Row className="g-0">
            ...
            <Col md={6}>
              <Card.Body>
                <Card.Title className="cardtitle">Visit the Dino Market</Card.Title>
                <Card.Text className="cardtext">
